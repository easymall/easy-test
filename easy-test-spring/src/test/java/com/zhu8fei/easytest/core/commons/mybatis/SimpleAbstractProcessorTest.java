package com.zhu8fei.easytest.core.commons.mybatis;
...
import com.zhu8fei.easytest.core.commons.data.SimpleAbstractProcessor;
import com.zhu8fei.easytest.core.commons.mybatis.mapper.SimpleMybatisMapper;
...
public class SimpleAbstractProcessorTest extends BaseJunitTest {
    ...
    public void insertPrepareData() throws Exception {
        ...
        SimpleAbstractProcessor simpleAbstractProcessor = Mockito.spy(SimpleAbstractProcessor.class);
        ...
        Field fieldMapper = clz.getDeclaredField("dataBaseMapper");
